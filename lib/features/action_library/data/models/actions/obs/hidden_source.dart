...
class HiddenSource extends BaseAction {
  String sceneName;
  String sourceName;
  ...
  static const String actionTypeName = 'hidden_source';

  HiddenSource({this.sceneName = '', this.sourceName = ''})
      : super(
            actionType: actionTypeName, dialogTitle: 'Enter scene and source') {
  ...
  @override
  HiddenSource copy() {
    return HiddenSource(sceneName: sceneName, sourceName: sourceName);
  }

  factory HiddenSource.fromJson(Json json) {
    return HiddenSource(
