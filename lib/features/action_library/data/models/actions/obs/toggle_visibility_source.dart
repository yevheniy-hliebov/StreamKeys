...
class ToggleVisibleSource extends BaseAction {
  String sceneName;
  String sourceName;
  ...
  static const String actionTypeName = 'toggle_visible_source';

  ToggleVisibleSource({this.sceneName = '', this.sourceName = ''})
      : super(
  ...
  FutureVoid execute({dynamic data}) async {
    if (sourceName.isNotEmpty) {
      ...
      if (itemId != null) {
        final enebled = await obs?.sceneItems.getEnabled(
  ...
  @override
  ToggleVisibleSource copy() {
    return ToggleVisibleSource(sceneName: sceneName, sourceName: sourceName);
  }

  factory ToggleVisibleSource.fromJson(Json json) {
    return ToggleVisibleSource(
