...
// in streamkeys/test/mobile/http_buttons_api_test.dart.
...
import 'package:streamkeys/core/storage/generic_secure_storage.dart' as _i4;
import 'package:streamkeys/core/storage/secure_storable.dart' as _i3;
...
class MockGenericSecureStorage<T extends _i3.SecureStorable> extends _i1.Mock
    implements _i4.GenericSecureStorage<T> {
  ...
  T Function(Map<String, String>) get fromMap => (super.noSuchMethod(
        ...
        returnValue: (Map<String, String> __p0) => _i5.dummyValue<T>(
          this,
          Invocation.getter(#fromMap),
        ),
  ...
  @override
  _i6.Future<T?> loadConnectionData() => (super.noSuchMethod(
        Invocation.method(
          #loadConnectionData,
          [],
        ),
  ...
  @override
  _i6.Future<void> updateConnectionData({required T? newData}) =>
      (super.noSuchMethod(
        Invocation.method(
