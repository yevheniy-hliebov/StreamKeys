...
import 'package:streamkeys/core/storage/generic_secure_storage.dart' as _i7;
import 'package:streamkeys/core/storage/secure_storable.dart' as _i6;
...
class MockGenericSecureStorage<T extends _i6.SecureStorable> extends _i1.Mock
    implements _i7.GenericSecureStorage<T> {
  ...
  T Function(Map<String, String>) get fromMap => (super.noSuchMethod(
        ...
        returnValue: (Map<String, String> __p0) => _i8.dummyValue<T>(
          this,
          Invocation.getter(#fromMap),
        ),
  ...
  @override
  _i9.Future<T?> loadConnectionData() => (super.noSuchMethod(
        Invocation.method(
          #loadConnectionData,
          [],
        ),
  ...
  @override
  _i9.Future<void> updateConnectionData({required T? newData}) =>
      (super.noSuchMethod(
        Invocation.method(
...
class MockObsWebSocketFactory extends _i1.Mock
    implements _i10.ObsWebSocketFactory {
  MockObsWebSocketFactory() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i9.Future<_i2.ObsWebSocket> connect(
    String? url, {
    ...
    required void Function(_i2.Event)? fallbackEventHandler,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i9.Future<_i2.ObsWebSocket>.value(_FakeObsWebSocket_0(
          this,
          Invocation.method(
            #connect,
            [url],
      ...
      ) as _i9.Future<_i2.ObsWebSocket>);
}
...
class MockObsWebSocket extends _i1.Mock implements _i2.ObsWebSocket {
  ...
  @override
  _i9.Stream<dynamic> get broadcastStream => (super.noSuchMethod(
  ...
  @override
  _i9.Future<void> authenticate() => (super.noSuchMethod(
        Invocation.method(
          #authenticate,
          [],
        ),
  ...
  @override
  _i9.Future<_i2.Opcode?> getStreamOpcode(int? webSocketOpCode) =>
      (super.noSuchMethod(
        Invocation.method(
          #getStreamOpcode,
          [webSocketOpCode],
        ),
        returnValue: _i9.Future<_i2.Opcode?>.value(),
      ) as _i9.Future<_i2.Opcode?>);

  @override
  _i9.Future<_i2.Opcode?> sendOpcode(_i2.Opcode? opcode) => (super.noSuchMethod(
        Invocation.method(
          #sendOpcode,
          [opcode],
        ),
  ...
  @override
  _i9.Future<void> listenForMask(int? eventSubscriptions) =>
      (super.noSuchMethod(
        Invocation.method(
          #listenForMask,
          [eventSubscriptions],
  ...
  @override
  _i9.Future<void> listen(dynamic eventSubscription) => (super.noSuchMethod(
        Invocation.method(
          #listen,
          [eventSubscription],
        ),
  ...
  @override
  _i9.Future<void> subscribe(_i2.EventSubscription? eventSubscription) =>
      (super.noSuchMethod(
        Invocation.method(
          #subscribe,
          [eventSubscription],
  ...
  @override
  _i9.Future<_i2.RequestResponse?> send(
    String? command, [
    Map<String, dynamic>? args,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i9.Future<_i2.RequestResponse?>.value(),
      ) as _i9.Future<_i2.RequestResponse?>);

  @override
  _i9.Future<_i2.RequestBatchResponse> sendBatch(List<_i2.Request>? requests) =>
      (super.noSuchMethod(
        Invocation.method(
          #sendBatch,
          [requests],
        ),
        returnValue: _i9.Future<_i2.RequestBatchResponse>.value(
            _FakeRequestBatchResponse_17(
          this,
          Invocation.method(
            #sendBatch,
      ...
      ) as _i9.Future<_i2.RequestBatchResponse>);

  @override
  _i9.Future<_i2.RequestResponse?> sendRequest(_i2.Request? request) =>
      (super.noSuchMethod(
        Invocation.method(
          #sendRequest,
          [request],
...
class MockGeneral extends _i1.Mock implements _i4.General {
  ...
  @override
  _i9.Future<_i2.VersionResponse> get version => (super.noSuchMethod(
        Invocation.getter(#version),
        returnValue:
            _i9.Future<_i2.VersionResponse>.value(_FakeVersionResponse_18(
          this,
          Invocation.getter(#version),
        )),
      ) as _i9.Future<_i2.VersionResponse>);

  @override
  _i9.Future<_i2.StatsResponse> get stats => (super.noSuchMethod(
        Invocation.getter(#stats),
        returnValue: _i9.Future<_i2.StatsResponse>.value(_FakeStatsResponse_19(
          this,
          Invocation.getter(#stats),
        )),
      ) as _i9.Future<_i2.StatsResponse>);

  @override
  _i9.Future<List<String>> get hotkeyList => (super.noSuchMethod(
        Invocation.getter(#hotkeyList),
        returnValue: _i9.Future<List<String>>.value(<String>[]),
      ) as _i9.Future<List<String>>);

  @override
  _i9.Future<_i2.VersionResponse> getVersion() => (super.noSuchMethod(
        Invocation.method(
          #getVersion,
          [],
        ),
  ...
  @override
  _i9.Future<_i2.StatsResponse> getStats() => (super.noSuchMethod(
        Invocation.method(
          #getStats,
          [],
        ),
  ...
  @override
  _i9.Future<void> broadcastCustomEvent(Map<String, dynamic>? arg) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i9.Future<_i2.CallVendorRequestResponse> callVendorRequest({
    ...
    _i2.RequestData? requestData,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i9.Future<_i2.CallVendorRequestResponse>.value(
            _FakeCallVendorRequestResponse_20(
          this,
          Invocation.method(
            #callVendorRequest,
      ...
      ) as _i9.Future<_i2.CallVendorRequestResponse>);

  @override
  _i9.Future<_i2.CallVendorRequestResponse> obsBrowserEvent({
  ...
  @override
  _i9.Future<List<String>> getHotkeyList() => (super.noSuchMethod(
        Invocation.method(
          #getHotkeyList,
          [],
        ),
  ...
  @override
  _i9.Future<void> triggerHotkeyByName(String? hotkeyName) =>
      (super.noSuchMethod(
        Invocation.method(
          #triggerHotkeyByName,
          [hotkeyName],
  ...
  @override
  _i9.Future<void> triggerHotkeyByKeySequence({
    String? keyId,
